...
APP_BUNDLE = $(DERIVED_DATA)/Build/Products/$(CONFIGURATION)/StockMonitor.app
SIDECAR_BINARY = rust/longbridge-bridge/target/$(RUST_PROFILE_DIR)/longbridge-bridge
RELEASE_ARCHIVE := .build/StockMonitor-Release.zip
...
help:
	@echo "StockMonitor build targets:"
